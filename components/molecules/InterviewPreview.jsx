    ...
    <>
      ...
      >
        <div className="lg:flex lg:justify-center lg:flex-col">
          ...
          {interview.quote && (
            <p className="text-Phone/Quote lg:text-Desktop/buttonsmall line-clamp-3 font-merriweather mt-2 mb-2 text-grey-80 text-center lg:mt-8 max-h-32 lg:max-h-20">
              {interview.quote}
            </p>
          )}
        </div>
